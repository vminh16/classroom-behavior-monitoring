...
def draw_box(im, np_boxes, labels, threshold=0.5):
    ...
    for dt in np_boxes:
        ...
        # draw label
        text = "{} {:.4f}".format(localize_label(labels[clsid]), score)
...
def draw_segm(im,
    ...
    for i in range(np_segms.shape[0]):
        ...
        bbox_text = '%s %.2f' % (localize_label(labels[clsid]), score)
...
def visualize_pose(imgfile,
    ...
    if kpt_nums == 17:  #plot coco keypoint
        EDGES = [(0, 1), (0, 2), (1, 3), (2, 4), (3, 5), (4, 6), (5, 7), (6, 8),
                 ...
                 (13, 15), (14, 16), (11, 12)]
    elif kpt_nums == 11:  #plot upper-body keypoint (11 points)
...
def draw_press_box_lanes(im, np_boxes, labels, threshold=0.5):
    ...
    for dt in np_boxes:
        ...
        # draw label
        text = "{}".format(localize_label(labels[clsid]))
        tw, th = imagedraw_textsize_c(draw, text)
        draw.rectangle(
